...
注册示例(任选其一):
  claude mcp add genshen-cp4 -- genshen-cp4-mcp
  # 或写入 .mcp.json / mcp_servers.json:
  {"mcpServers": {"genshen-cp4": {"command": "genshen-cp4-mcp", "args": []}}}
...
TOOLS = [
    ...
    },
    {
        ...
        "inputSchema": {
            "type": "object",
            "properties": {
                "out_dir": {"type": "string", "description": "输出目录, 默认 ~/.genshen-cp4/wallpapers"},
